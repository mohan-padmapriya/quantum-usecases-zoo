...
description: Industrial nitrogen fixation via the Haber-Bosch process consumes ~2% of global electricity. Quantum simulation of the FeMoco active site is a canonical fault-tolerant-era use case with no near-term practical advantage.
...
Advanced density functional theory and coupled-cluster methods achieved chemical accuracy on FeMoco by 2026. Key result: Lee & Chan (2023) _Nature Communications_ showed no evidence of generic exponential advantage in ground-state chemistry. Classical methods continue improving; no quantum system has beaten them on this problem.
