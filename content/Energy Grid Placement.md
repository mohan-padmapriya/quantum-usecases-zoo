...
The use case is considered highly strategic for national energy security and the Net-Zero transition, drawing active participation from entities such as Alliander, E.ON, and Commonwealth Edison. It is also a regular in "quantum for SDG" lists. 
